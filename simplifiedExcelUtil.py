...
class ExcelUtil:
    ...
    def createExcelChart(self):
        ...
        # Add a chart title  
        self.chart1.set_title ({'name': 'Graph'}) 
        # Add x-axis label 
        self.chart1.set_x_axis({'name': 'x axis',
                                'name_layout': {
                                'x': 0.34,
                                'y': 0.85,
                                }
        ...
        # Add y-axis label 
        self.chart1.set_y_axis({'name': 'y axis'})
        ...
        # a chart is anchored to cell B9.  
        self.worksheet.insert_chart('B9', self.chart1, {'x_offset': 25, 'y_offset': 10})
    ...
    def timeStamp(self):
        ...
        print ('function results file:',self.filename_stamped)
